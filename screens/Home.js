  ...
  return (
    <View style={styles.container}>
      <View style={styles.textWrapper}>
        <View>
          <Text style={styles.text01}>나만의 생리대 추천 받기</Text>
          <Text style={styles.text02}>1. 카메라로 생리대 성분표 찍기</Text>
          <Text style={styles.text02}>
            2. 비슷한 성분의 다른 생리대 추천 받기
          </Text>
        </View>
        <View>
          <Text style={styles.text01}>다양한 월경 정보 얻기</Text>
          <Text style={styles.text02}>1. 콘텐츠에 터치해서 들어가기</Text>
          <Text style={styles.text02}>
            2. 다양한 콘텐츠 중 궁금했던 월경 정보 얻기
          </Text>
        </View>
      </View>
      <View>
        <Text style={{ fontSize: 34, fontWeight: "bold", left: 40, top: 40 }}>
          Contents
        </Text>
      </View>
      <TouchableOpacity onPress={pressAllHandler}>
        <Text style={{ fontSize: 16, left: 300, top: 10 }}>
          {" "}
          전체보기 {">"}
        </Text>
      </TouchableOpacity>
        ...
        {slideList.slice(0, 3).map((slide) => (
          ...
          >
            <View style={styles.slideImageWrapper}>
              <ImageBackground source={slide.image} style={styles.slideImage} />
            </View>
